...
Public Class frmDiscountCode
    ...
    Public Sub Local_frm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Catch eLoad As System.Exception
            PlushBuziness.clsMsgError.InsertLogMsg(PlushData.clsMsgError.processType.Discount, eLoad)
    ...
    Public Sub LoadBKComboMaint()
        Try
            ...
            cmbGroup_Partner.Properties.DataSource = GetListCmb(PlushData.clsActivationCode.GetActivationGroup(), "activation_group_name", "activation_group_id")
            ...
            cmbAboType.Properties.DataSource = GetListCmb(PlushData.clsActivationCode.GetProducts(PlushData.clsActivationCode.productsTypeAbo), "products_title", "products_id")
            ...
            txtValidityTo_Type.Properties.DataSource = GetListCmb(PlushData.clsActivationCode.GetDiscountAboValidityType(), "discount_abo_validityto_type_name", "discount_abo_validityto_type_id")
            ...
            cmbDiscount_Type.Properties.DataSource = GetListCmb(PlushData.clsActivationCode.GetDiscountType(), "discount_explained", "discount_type")
            ...
            txtNextDiscountCode.Properties.DataSource = GetListCmb(PlushData.clsActivationCode.GetDiscountCode(), "discount_code", "discount_code_id")
            ...
            cmbShoppingDiscountType.Properties.DataSource = GetListCmb(PlushData.clsActivationCode.GetDiscountType(), "discount_explained", "discount_type")
            ...
            cmbGroupIDsearch.Properties.DataSource = GetListCmb(PlushData.clsActivationCode.GetActivationGroup(), "activation_group_name", "activation_group_id")
    ...
    Private Function UpdateDiscount(ByVal discount_code As String) As Boolean
        Dim ok As Boolean
        Dim cnt As Integer
        ok = PlushData.clsConnection.ExecuteScalar(PlushData.clsActivationCode.GetExistNewDiscount(discount_code))
        If ok Then


            Dim sql As String
            sql = PlushData.clsActivationCode.updateDiscountCode(_discountCode, _discountType, _
    ...
    Private Function GetInfoDiscount(ByVal discount_id As Integer) As DataRow
        ...
        sql = PlushData.clsActivationCode.GetDiscountSearch(discount_id)
        dt = PlushData.clsConnection.FillDataSet(sql)
        Return dt.Rows(0)
    End Function
    ...
    Private Sub loadDiscountExpiration() 'by gauthier
        Dim dt As DataTable
        Dim sqlDiscountExp As String = PlushData.clsActivationCode.GetDiscountExpiration()
        dt = PlushData.clsConnection.FillDataSet(sqlDiscountExp)
    ...
    Private Sub loadAllDiscount()
        ...
        sql = PlushData.clsActivationCode.GetDiscountCodeDesc()
        dt = PlushData.clsConnection.FillDataSet(sql)
        GridControl1.MainView = GridViewDiscount
        GridControl1.DataSource = dt
    ...
    Public Sub search()
        ...
        sqlDiscount = PlushData.clsActivationCode.GetDiscountSearch(discountId, discountCode, groupPartnerId, validityFrom, validityTo)

        GridControl1.MainView = GridViewDiscount
        dt = PlushData.clsConnection.FillDataSet(sqlDiscount)
        GridControl1.DataSource = dt
    ...
    Private Sub btnNewDiscount_click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNewDiscount.Click
        EnablingEditFields(True)
        txtDiscount_Code.EditValue = PlushData.clsActivationCode.NEWDISCOUNT
    ...
    Private Sub insertNewCode()
        ...
        sql = PlushData.clsActivationCode.insertDiscount(_discountCode, _discountType, _
                                                                   _discountValue, _discountLimit, _discountCommitment, _
                                                                   _discountStatus, _discountTextFr, _discountTextNl, _discountTextEn, _
                                                                   _discountAboValiditytoType, _discountAboValiditytoValue, _commentDiscount, _iscountNbrMonthBeforeReuse, _
                                                                   _discountRecurringNbrOfMonth, _bypassDiscountuse, _discountValidityTo, _payable, _
    ...
    Private Function GetShoppingDiscount(Optional ByVal shopping_discount_id As Integer = 0) As DataTable
        ...
        sql = PlushData.clsActivationCode.GetshoppingDIscount(shopping_discount_id)
        dt = PlushData.clsConnection.FillDataSet(sql)
    ...
    Private Function updatedShoppingDiscount(ByVal shopping_discount_code As String) As Boolean
        Dim ok As Boolean
        Dim cnt As Integer
        ok = PlushData.clsConnection.ExecuteScalar(PlushData.clsActivationCode.GetExistShoppingDiscount(shopping_discount_code))
        If ok Then


            Dim sql As String
            sql = PlushData.clsActivationCode.updateShoppingDiscount(shopping_discount_code, _shoppingDiscountType, _
    ...
    Private Sub insertNewShoppingDiscount()
        Dim sql As String
        Dim cnt As Integer
        sql = PlushData.clsActivationCode.insertShoppingDiscount(_shoppingdiscountCode, _shoppingDiscountType, _
                                                                                 _shoppingDiscountValue, _shoppingDiscountStatus, _
                                                                                 _shoppingDiscountTextFR, _shoppingDiscountTextNl, _shoppingDiscountTextEn, _
                                                                                 _shoppingDiscountValidityTo)
        PlushData.clsConnection.CreateTransaction(True)
    ...
    Private Sub btnShoppingNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShoppingNew.Click
        txtShoppingDiscount.EditValue = PlushData.clsActivationCode.NEWDISCOUNT
    ...
    Private Sub btnXls_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnXls.Click
        PlushBuziness.clsExport.ExportXls(GridViewDiscount)
    End Sub
End Class
