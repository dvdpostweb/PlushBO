...
#End Region
    ...
    Public Sub this_frm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            TableName = "common_production.reviews"
            IDField = "id"
            NameField = "id"
    ...
    Public Overrides Sub gridview1_doubleclick(ByVal sender As System.Object, ByVal e As System.EventArgs) 'Handles GridView1.DoubleClick
        ...
        Dim _imdb_id As Integer
        Dim _i As Integer = GridView1.FocusedRowHandle
        _ID = GridView1.GetDataRow(_i)("id")
        _customers_id = GridView1.GetDataRow(_i)("customers_id")
        _imdb_id = GridView1.GetDataRow(_i)("imdb_id")
        _frm.txtReviewID.EditValue = _ID
