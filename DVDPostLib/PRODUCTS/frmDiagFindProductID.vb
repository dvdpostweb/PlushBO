...
#End Region
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        PlushData.clsConnection.FillDataSet(objDS.Tables("products_description1"), _SQLTxt)
        cmbProductID.Focus()
        cmbProductID.ShowPopup()
    End Sub
    ...
    Private Sub RefreshDVDInfo()
        ...
        PlushData.clsConnection.FillDataSet(objDS.Tables("products_combo"), _SQLTxt)
        ...
        PlushData.clsConnection.FillDataSet(objDS.Tables("products_dvd"), _SQLTxt)
    End Sub
