...
#End Region
    ...
    Public Overrides Sub LoadDataSet()
        ...
        PlushData.clsConnection.FillDataSet(objDS.Tables(TableName), PlushData.clsAboStopWhy.getAboStop(_DateFromTxt, _DateToTxt))
        ...
        If chkPreviousAvtion.Checked = True Then
            ...
            For Each _row In objDS.Tables(TableName).Rows
                ...
                If Not IsDBNull(_row("customers_id")) Then
                    ...
                    PlushData.clsConnection.FillDataSet(_DS.Tables("abo"), PlushData.clsAboStopWhy.getPreviousAction(_row("customers_id")))
