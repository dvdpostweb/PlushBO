...
#End Region
    ...
    Public Overrides Sub LoadDataSet()
        ...
        _SQLTxt = " SELECT distinct  p.*, op.orders_products_id, op.orders_id, op.products_model AS op_products_model, op.products_name, op.products_price AS op_products_price,  " & _
            ...
            " WHERE date(o.date_purchased) >= '" & PlushTools.ClsDate.formatDate(txtDateFrom.DateTime) & "'" & _
            " AND date(o.date_purchased) <= '" & PlushTools.ClsDate.formatDate(txtDateTo.DateTime) & "'" & _
    ...
    Public Sub MergeProductInfo()
        ...
        If chkSubTitles.Checked Then
            ...
            PlushData.clsConnection.FillDataSet(_tmpDS.Tables("products_undertitles_View1"), _SqlTxt)
        End If
        If chkLanguages.Checked Then
            ...
            PlushData.clsConnection.FillDataSet(_tmpDS.Tables("products_languages_View1"), _SqlTxt)
        End If
