...
#End Region
    ...
    Public Shared Function CreatePathFile(ByVal tBatch As String, ByVal country As String) As String
        ...
        nameFile = country & "_" & tBatch.ToString() & "_" & PlushTools.ClsDate.formatDate() & ".txt"
    ...
    Public Shared Function CreatePathFileADULTSVOD(ByVal tBatch As String, ByVal country As String) As String
        ...
        path_file = Configuration.ConfigurationManager.AppSettings(KEYFILE)
        nameFile = "ADULTSVOD_" & country & "_" & tBatch.ToString() & "_" & PlushTools.ClsDate.formatDate() & ".txt"
    ...
    Private Function LineData(ByVal drReconduction As DataRow, ByVal numsequence As Integer, ByVal strcommunication As String) As String
        ...
        Try
            ...
            stramount = PlushTools.ClsPrice.castPriceDbToPriceBatch(stramount)
    ...
    Public Function GenerateFile(ByVal dtReconduction As DataTable) As String
        ...
        lastDomId = PlushData.clsConnection.ExecuteScalar(sql)
